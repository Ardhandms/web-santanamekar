...
function Page() {
  ...
  // Daftar gambar
  const images = [
    { src: "/fotoUmkm/cimpring1.png", alt: "Komoditas Puyuh" },
    ...
    <main className="relative bg-black flex justify-center items-center flex-col overflow-hidden mx-auto sm:px-10 px-5">
      <div className="pb-20 pt-16 mb-24" id="gulaaren">
        <h1 className="text-3xl sm:text-4xl font-bold text-center mb-10">
          Makanan Ringan Cimpring Milenium{" "}
        ...
        <div className="py-6 px-5 sm:px-20 max-w-[89vw] md:max-w-2xl lg:max-w-[60vw]">
          <p className="text-base sm:text-lg text-neutral-600 dark:text-neutral-300 leading-relaxed mb-2">
            Cimpring Milenium adalah salah satu UMKM kebanggaan Desa
            Santanamekar yang bergerak di bidang produksi makanan ringan.
            Produk-produk Cimpring ini, terkenal akan cita rasa yang gurih dan
            kualitasnya yang terjamin. Dengan menggunakan bahan-bahan alami dari
            desa sendiri, Japilus berhasil menghadirkan camilan yang tidak hanya
            lezat tetapi juga sehat dan aman untuk dikonsumsi.
          </p>
          <p className="text-base sm:text-lg text-neutral-600 dark:text-neutral-300 leading-relaxed mb-2">
            UMKM Cimpring Milenium juga berperan besar dalam memperkenalkan
            kuliner khas Desa Santanamekar ke pasar yang lebih luas, baik lokal
            maupun regional. Selain menjadi favorit masyarakat.
          </p>
